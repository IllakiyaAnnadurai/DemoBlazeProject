package com.illakiya.stepDefinition;
...
import com.illakiya.utilities.CommonUtils;
...
public class SignUpSteps {
	...
	public void user_clicks_on_close_button_in_sign_up() {
		try {
			...
			wait.until(ExpectedConditions.elementToBeClickable(SignupPageOR.getInstance().getClose()));
		Actions actions = new Actions(DriverManager.getDriver());
		actions.moveToElement(SignupPageOR.getInstance().getClose()).click(SignupPageOR.getInstance().getClose());
		actions.perform();
		//SignupPageOR.getInstance().getClose().click();
